...
import { handleLoginSubmit } from "@/lib/login-utils"
...
export function LoginPage({
  ...
  const setState = (state: { error?: string; loading?: boolean }) => {
  ...
  const onSubmit = (e: FormEvent<HTMLFormElement>) => {
    handleLoginSubmit(e, { email, password }, setState, resetForm, (result) => {
      login(result.email, result.token, result.userId, result.tokenType)
      navigate("/")
    })
  }
